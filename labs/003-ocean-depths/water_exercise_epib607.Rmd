---
title: Exercise - How Deep is the Ocean? September 18, 2020.
params:
  email:
...
abstract: |
  This in-class exercise will introduce you to sampling distributions for means and proportions. We will do this exercise in class on Friday September 18 in small breakout rooms. And then discuss the results altogether. Take the opportunity to introduce yourself to your peers in the breakout room. Discuss the exercise together. 
...
source("https://github.com/sahirbhatnagar/EPIB607/raw/master/labs/003-ocean-depths/automate_water_task.R")
```
...
water_results <- read.csv("EPIB607_FALL2020_water_exercise - water.csv", as.is=TRUE)
