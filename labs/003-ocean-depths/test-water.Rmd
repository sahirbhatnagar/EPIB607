---
title: Exercise - How Deep is the Ocean? September 16, 2020.
params:
  email:
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[scale = 0.90]{lat-long.png} 
  \end{center}
...
path <- 
"https://github.com/sahirbhatnagar/EPIB607/raw/gh-pages/resources/assets/labs/003-ocean-depths/automate_water_task.R"
source(path)
```
