...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{allLocations <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"/home/sahir/git_repositories/EPIB607/resources/assets/labs/003-ocean-depths/earth-locations-20180914.csv"}\NormalTok{)}
\NormalTok{allLocations}\OperatorTok{$}\NormalTok{water  =}\StringTok{ }\DecValTok{1}\OperatorTok{*}\NormalTok{(allLocations}\OperatorTok{$}\NormalTok{alt }\OperatorTok{<}\StringTok{ }\DecValTok{0}\NormalTok{)}
\CommentTok{# plot(allLocations$lon[allLocations$water==1],}
\CommentTok{#      allLocations$lat[allLocations$water==1],}
\CommentTok{#      col="blue",cex=0.02)}
\CommentTok{# plot( table( round(allLocations $lat) ) )}
\CommentTok{# water only}
\NormalTok{depthsOfWater <-}\StringTok{ }\NormalTok{allLocations[allLocations}\OperatorTok{$}\NormalTok{water }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{,]}
\NormalTok{depthsOfWater}\OperatorTok{$}\NormalTok{depth <-}\StringTok{ }\OperatorTok{-}\NormalTok{depthsOfWater}\OperatorTok{$}\NormalTok{alt}
\CommentTok{# str(depthsOfWater)}
\CommentTok{# summary(depthsOfWater)}
\CommentTok{# hist(depthsOfWater$depth,breaks=100)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{params}\OperatorTok{$}\NormalTok{name}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{params}\OperatorTok{$}\NormalTok{email}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{params}\OperatorTok{$}\NormalTok{ind}
\KeywordTok{round}\NormalTok{(allLocations}\OperatorTok{$}\NormalTok{lon[params}\OperatorTok{$}\NormalTok{ind],}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{cat}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Latitude.n."}\NormalTok{,}\KeywordTok{toString}\NormalTok{(n),}\StringTok{" <- c("}\NormalTok{,}
                \KeywordTok{paste}\NormalTok{(}\KeywordTok{round}\NormalTok{(allLocations}\OperatorTok{$}\NormalTok{lat[params}\OperatorTok{$}\NormalTok{ind5],}\DecValTok{3}\NormalTok{),}
                      \DataTypeTok{collapse=}\StringTok{","}\NormalTok{),}\StringTok{")"}\NormalTok{, }\DataTypeTok{sep=}\StringTok{""}\NormalTok{ ))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cat}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Longitude.n."}\NormalTok{,}\KeywordTok{toString}\NormalTok{(n),}\StringTok{" <- c("}\NormalTok{,}
                \KeywordTok{paste}\NormalTok{(}\KeywordTok{round}\NormalTok{(allLocations}\OperatorTok{$}\NormalTok{lon[params}\OperatorTok{$}\NormalTok{ind5],}\DecValTok{3}\NormalTok{),}
                      \DataTypeTok{collapse=}\StringTok{","}\NormalTok{),}\StringTok{")"}\NormalTok{, }\DataTypeTok{sep=}\StringTok{""}\NormalTok{ ))}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{cat}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Latitude.n."}\NormalTok{,}\KeywordTok{toString}\NormalTok{(n),}\StringTok{" <- c("}\NormalTok{,}
                \KeywordTok{paste}\NormalTok{(}\KeywordTok{round}\NormalTok{(allLocations}\OperatorTok{$}\NormalTok{lat[params}\OperatorTok{$}\NormalTok{ind20][}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{],}\DecValTok{3}\NormalTok{),}
                      \DataTypeTok{collapse =}\StringTok{","}\NormalTok{),}\StringTok{","}\NormalTok{,}\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
          \KeywordTok{paste}\NormalTok{(}\KeywordTok{round}\NormalTok{(allLocations}\OperatorTok{$}\NormalTok{lat[params}\OperatorTok{$}\NormalTok{ind20][}\DecValTok{11}\OperatorTok{:}\DecValTok{20}\NormalTok{],}\DecValTok{3}\NormalTok{),}
...
\begin{Highlighting}[]
\KeywordTok{cat}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Longitude.n."}\NormalTok{,}\KeywordTok{toString}\NormalTok{(n),}\StringTok{" <- c("}\NormalTok{,}
                \KeywordTok{paste}\NormalTok{(}\KeywordTok{round}\NormalTok{(allLocations}\OperatorTok{$}\NormalTok{lon[params}\OperatorTok{$}\NormalTok{ind20][}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{],}\DecValTok{3}\NormalTok{),}
                      \DataTypeTok{collapse =}\StringTok{","}\NormalTok{),}\StringTok{","}\NormalTok{,}\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
          \KeywordTok{paste}\NormalTok{(}\KeywordTok{round}\NormalTok{(allLocations}\OperatorTok{$}\NormalTok{lon[params}\OperatorTok{$}\NormalTok{ind20][}\DecValTok{11}\OperatorTok{:}\DecValTok{20}\NormalTok{],}\DecValTok{3}\NormalTok{),}
                      \DataTypeTok{collapse =}\StringTok{","}\NormalTok{),}
          \StringTok{")"}\NormalTok{, }\DataTypeTok{sep =} \StringTok{""}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cat}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"landed_in_water"}\NormalTok{, }\StringTok{" <- c("}\NormalTok{,}
                \KeywordTok{paste}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{),}
                      \DataTypeTok{collapse =} \StringTok{","}\NormalTok{),}\StringTok{")"}\NormalTok{, }\DataTypeTok{sep=}\StringTok{""}\NormalTok{ ))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{n <-}\StringTok{ }\DecValTok{20}
\KeywordTok{cat}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"index.n."}\NormalTok{,}\KeywordTok{toString}\NormalTok{(n),}\StringTok{" <- c("}\NormalTok{,}
                \KeywordTok{paste}\NormalTok{(params}\OperatorTok{$}\NormalTok{ind20[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{],}
                      \DataTypeTok{collapse =} \StringTok{","}\NormalTok{),}\StringTok{","}\NormalTok{,}\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
          \KeywordTok{paste}\NormalTok{(params}\OperatorTok{$}\NormalTok{ind20[}\DecValTok{11}\OperatorTok{:}\DecValTok{20}\NormalTok{],}
                      \DataTypeTok{collapse =} \StringTok{","}\NormalTok{),}
          \StringTok{")"}\NormalTok{, }\DataTypeTok{sep =} \StringTok{""}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{n <-}\StringTok{ }\DecValTok{5}
\KeywordTok{cat}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"index.n."}\NormalTok{,}\KeywordTok{toString}\NormalTok{(n),}\StringTok{" <- c("}\NormalTok{,}
                \KeywordTok{paste}\NormalTok{(params}\OperatorTok{$}\NormalTok{ind5,}
                      \DataTypeTok{collapse =} \StringTok{","}\NormalTok{),}
          \StringTok{")"}\NormalTok{, }\DataTypeTok{sep =} \StringTok{""}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
