...
\KeywordTok{install.packages}\NormalTok{(}\StringTok{"aplore3"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{addmargins}\NormalTok{(}\KeywordTok{table}\NormalTok{(icu}\OperatorTok{$}\NormalTok{sta, icu}\OperatorTok{$}\NormalTok{cpr,}
             \DataTypeTok{dnn =} \KeywordTok{c}\NormalTok{(}\StringTok{"Survival"}\NormalTok{, }\StringTok{"Prior CPR"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{odds =}\StringTok{ }\DecValTok{154}\OperatorTok{/}\DecValTok{33}
\NormalTok{odds}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{p =}\StringTok{ }\NormalTok{(odds)}\OperatorTok{/}\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{odds)}
\NormalTok{p}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#calculate odds}
\NormalTok{odds =}\StringTok{ }\DecValTok{6}\OperatorTok{/}\DecValTok{7}
\NormalTok{odds}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#create two-way table}
\KeywordTok{addmargins}\NormalTok{(}\KeywordTok{table}\NormalTok{(icu}\OperatorTok{$}\NormalTok{sta, icu}\OperatorTok{$}\NormalTok{cre,}
       \DataTypeTok{dnn =} \KeywordTok{c}\NormalTok{(}\StringTok{"Survival"}\NormalTok{, }\StringTok{"Creatinine"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{odds =}\StringTok{ }\DecValTok{155}\OperatorTok{/}\DecValTok{35}
\NormalTok{odds}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p =}\StringTok{ }\DecValTok{5}\OperatorTok{/}\DecValTok{10}
\NormalTok{p}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{glm}\NormalTok{(sta }\OperatorTok{~}\StringTok{ }\NormalTok{cpr, }\DataTypeTok{data =}\NormalTok{ icu, }\DataTypeTok{family =} \KeywordTok{binomial}\NormalTok{(}\DataTypeTok{link =} \StringTok{"logit"}\NormalTok{))}\OperatorTok{$}\NormalTok{coef}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{summary}\NormalTok{(}\KeywordTok{glm}\NormalTok{(sta }\OperatorTok{~}\StringTok{ }\NormalTok{cpr, }\DataTypeTok{data =}\NormalTok{ icu, }\DataTypeTok{family =} \KeywordTok{binomial}\NormalTok{(}\DataTypeTok{link =} \StringTok{"logit"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{glm}\NormalTok{(sta }\OperatorTok{~}\StringTok{ }\NormalTok{cre, }\DataTypeTok{data =}\NormalTok{ icu, }\DataTypeTok{family =} \KeywordTok{binomial}\NormalTok{(}\DataTypeTok{link =} \StringTok{"logit"}\NormalTok{))}\OperatorTok{$}\NormalTok{coef}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#fit the model}
\KeywordTok{summary}\NormalTok{(}\KeywordTok{glm}\NormalTok{(sta }\OperatorTok{~}\StringTok{ }\NormalTok{cre, }\DataTypeTok{data =}\NormalTok{ icu, }\DataTypeTok{family =} \KeywordTok{binomial}\NormalTok{(}\DataTypeTok{link =} \StringTok{"logit"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#fit the model}
\KeywordTok{glm}\NormalTok{(sta }\OperatorTok{~}\StringTok{ }\NormalTok{age, }\DataTypeTok{data =}\NormalTok{ icu, }\DataTypeTok{family =} \KeywordTok{binomial}\NormalTok{(}\DataTypeTok{link =} \StringTok{"logit"}\NormalTok{))}\OperatorTok{$}\NormalTok{coef}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{icu.model.age =}\StringTok{ }\KeywordTok{glm}\NormalTok{(sta }\OperatorTok{~}\StringTok{ }\NormalTok{age, }\DataTypeTok{data =}\NormalTok{ icu, }\DataTypeTok{family =} \KeywordTok{binomial}\NormalTok{(}\DataTypeTok{link =} \StringTok{"logit"}\NormalTok{))}
\NormalTok{log.odds =}\StringTok{ }\KeywordTok{predict}\NormalTok{(icu.model.age, }\DataTypeTok{newdata =} \KeywordTok{data.frame}\NormalTok{(}\StringTok{"age"}\NormalTok{ =}\StringTok{ }\DecValTok{70}\NormalTok{))}

\KeywordTok{exp}\NormalTok{(log.odds)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{difference.odds =}\StringTok{ }\NormalTok{icu.model.age}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\NormalTok{(}\DecValTok{70-45}\NormalTok{)}
\KeywordTok{exp}\NormalTok{(difference.odds)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{exp}\NormalTok{(}\OperatorTok{-}\NormalTok{difference.odds)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{log.odds}\FloatTok{.70}\NormalTok{ =}\StringTok{ }\KeywordTok{predict}\NormalTok{(icu.model.age, }\DataTypeTok{newdata =} \KeywordTok{data.frame}\NormalTok{(}\StringTok{"age"}\NormalTok{ =}\StringTok{ }\DecValTok{70}\NormalTok{))}
\NormalTok{log.odds}\FloatTok{.45}\NormalTok{ =}\StringTok{ }\KeywordTok{predict}\NormalTok{(icu.model.age, }\DataTypeTok{newdata =} \KeywordTok{data.frame}\NormalTok{(}\StringTok{"age"}\NormalTok{ =}\StringTok{ }\DecValTok{45}\NormalTok{))}
\KeywordTok{exp}\NormalTok{(log.odds}\FloatTok{.45}\NormalTok{)}\OperatorTok{/}\KeywordTok{exp}\NormalTok{(log.odds}\FloatTok{.70}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
