...
\title{Lab 005 - Inference for proportions.}
...
\begin{abstract}
In this exercise you will practice doing inference for one-sample
proportions.
\end{abstract}
...
\pinpfootercontents{in-class exercise on proportions}
