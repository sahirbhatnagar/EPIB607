...
{\centering \includegraphics[width=1\linewidth]{downloadFigs4latex_003-exploring-data-1/masks} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in library(covdata): there is no package called 'covdata'}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in dplyr::left\_join(., pop\_county, by = c("{}state"{}, "{}fips"{})): object 'nytcovcounty' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in dplyr::group\_by(., state, date): object 'county\_level' not found}}\begin{alltt}
...
other attached packages:
 [1] ggeffects_0.16.0    openintro_2.0.0     usdata_0.1.0       
 [4] cherryblossom_0.1.0 airports_0.1.0      oibiostat_0.2.0    
 [7] NCStats_0.4.7       FSA_0.8.30          forcats_0.5.0      
[10] stringr_1.4.0       dplyr_1.0.2         purrr_0.3.4        
[13] readr_1.4.0         tidyr_1.1.2         tibble_3.0.6       
[16] ggplot2_3.3.3       tidyverse_1.3.0     knitr_1.31         
...
loaded via a namespace (and not attached):
 ...
 [16] ggrepel_0.8.2      fansi_0.4.2        mvtnorm_1.1-1     
 [19] lubridate_1.7.9    xml2_1.3.2         codetools_0.2-16  
 [22] mosaic_1.7.0       splines_4.0.2      sjmisc_2.8.5      
 [25] polyclip_1.10-0    jsonlite_1.7.2     nloptr_1.2.2.2    
 [28] broom_0.7.2        dbplyr_1.4.4       ggforce_0.3.2     
 [31] effectsize_0.3.3   compiler_4.0.2     httr_1.4.2        
 [34] sjstats_0.18.0     emmeans_1.5.1      backports_1.2.1   
 [37] assertthat_0.2.1   Matrix_1.2-18      cli_2.3.0         
 [40] formatR_1.7        tweenr_1.0.1       htmltools_0.5.1.1 
 [43] coda_0.19-4        gtable_0.3.0       glue_1.4.2        
 [46] Rcpp_1.0.6         carData_3.0-4      cellranger_1.1.0  
 [49] vctrs_0.3.6        sjPlot_2.8.5       nlme_3.1-149      
 [52] crosstalk_1.1.0.1  insight_0.9.6      xfun_0.21         
 [55] ps_1.5.0           lme4_1.1-23        openxlsx_4.1.5    
 [58] rvest_0.3.6        lifecycle_1.0.0    mosaicCore_0.8.0  
 [61] pacman_0.5.1       statmod_1.4.34     zoo_1.8-8         
 [64] MASS_7.3-53        scales_1.1.1       hms_0.5.3         
 [67] sandwich_2.5-1     curl_4.3           mosaicData_0.20.1 
 [70] gridExtra_2.3      TeachingDemos_2.12 stringi_1.5.3     
 [73] highr_0.8          bayestestR_0.7.2   boot_1.3-25       
 [76] zip_2.1.1          rlang_0.4.10       pkgconfig_2.0.3   
 [79] evaluate_0.14      lattice_0.20-41    htmlwidgets_1.5.3 
 [82] labeling_0.4.2     tidyselect_1.1.0   ggformula_0.9.4   
 [85] plyr_1.8.6         magrittr_2.0.1     R6_2.5.0          
 [88] generics_0.1.0     multcomp_1.4-13    DBI_1.1.0         
 [91] pillar_1.4.7       haven_2.3.1        foreign_0.8-80    
 [94] withr_2.4.1        survival_3.2-3     abind_1.4-5       
 [97] performance_0.5.0  modelr_0.1.8       crayon_1.4.1      
[100] car_3.0-9          utf8_1.1.4         grid_4.0.2        
[103] readxl_1.3.1       data.table_1.13.6  blob_1.2.1        
