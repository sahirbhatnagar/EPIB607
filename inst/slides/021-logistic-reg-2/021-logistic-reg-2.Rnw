...
\lhead{021 - Logistic Regression II (HIV and Smoking examples)}
...
ds.for.mh=read.csv("~/git_repositories/EPIB607/slides/021-logistic-reg-2/hiv_Transmission_mantel_haenszel.csv",
header=TRUE)
@
...
library(NCStats)
ds=read.csv("~/git_repositories/EPIB607/slides/021-logistic-reg-2/hiv_Transmission.csv",header=TRUE)
