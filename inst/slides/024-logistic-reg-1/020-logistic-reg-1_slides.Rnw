...
\begin{figure}[h]
	\centering
	\includegraphics[scale=1.1]{~/git_repositories/EPIB607/slides/020-logistic-reg/hivtable.pdf}
\end{figure}


<<echo=FALSE, eval=TRUE, message=FALSE, size = 'small'>>=
ds.for.mh=read.csv("~/git_repositories/EPIB607/slides/020-logistic-reg-1/hiv_Transmission_mantel_haenszel.csv",
header=TRUE)
@
...
ds=read.csv("~/git_repositories/EPIB607/slides/020-logistic-reg-1/hiv_Transmission.csv",header=TRUE)
