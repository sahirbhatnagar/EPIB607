...
```{r qualitative-scales, fig.width=5*6/4.2, fig.asp=3*.14, fig.cap = '(ref:qualitative-scales)', echo=FALSE}
...
```{r popgrowth-US, fig.width = 6, fig.asp = 1.2, fig.cap = '(ref:popgrowth-US)', echo=TRUE, warning=FALSE}
...
```{r sequential-scales, fig.width=5*6/4.2, fig.asp=3*.14, fig.cap = '(ref:sequential-scales)', echo=FALSE}
p1 <- gg_color_swatches(7, title_family = dviz_font_family) + 
...
```{r map-Texas-income, fig.width = 6, fig.asp = 0.75, fig.cap = '(ref:map-Texas-income)', echo=TRUE}
...
```{r diverging-scales, fig.width=5*6/4.2, fig.asp=3*.14, fig.cap = '(ref:diverging-scales)', echo=FALSE}
p1 <- gg_color_swatches(7, title_family = dviz_font_family) + 
...
```{r map-Texas-race, fig.width = 6, fig.asp = 0.75, fig.cap = '(ref:map-Texas-race)', echo=TRUE}
...
```{r accent-scales, fig.width=5*6/4.2, fig.asp=3*.14, fig.cap = '(ref:accent-scales)', echo=FALSE}
...
```{r popgrowth-US-highlight, fig.width = 6, fig.asp = 1.2, fig.cap = '(ref:popgrowth-US-highlight)', echo=TRUE}
...
```{r Aus-athletes-track, fig.width = 6, fig.cap='(ref:Aus-athletes-track)', echo=TRUE}
