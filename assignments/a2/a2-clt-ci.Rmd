...
a. Find the mean and standard deviation of the donations.
b. During their annual membership drive, they hope to
...
c. Consider the mean donation of the 50 new members
each day. Describe the sampling model for these
means (shape, center, and spread).
d. Assume a hypothetical cohort of 1000 members follows the distribution in the Table. Plot the frequency histogram of the donation amounts. 
