---
title: Assignment 4 - Poisson and Logistic Regression. Due November 30, 11:59pm 2020
author:
...
pt <- read.table("~/git_repositories/EPIB607/slides/020-logistic-reg-1/denmark_person_time.txt", skip = 1, header = TRUE)
pt$type <- "PT"
deaths <- read.table("~/git_repositories/EPIB607/slides/020-logistic-reg-1/denmark_deaths.txt", skip = 1, 
header = TRUE)
deaths$type <- "deaths"
df <- rbind(pt, deaths)
...
readr::write_csv(df, file = "~/git_repositories/EPIB607/assignments/a4/denmark.csv")

pt <- read.csv("~/git_repositories/EPIB607/assignments/a4/denmark.csv")
# str(pt)
```
