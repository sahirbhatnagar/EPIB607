...
pacman::p_load(rio)
pacman::p_load(DT)
if(!requireNamespace("oibiostat")) devtools::install_github("OI-Biostat/oi_biostat_data")
if(!requireNamespace("openintro")) devtools::install_github("OpenIntroStat/openintro")
