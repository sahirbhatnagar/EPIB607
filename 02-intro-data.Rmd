...
```{r famussFrequencyTable, echo=FALSE}
data(famuss); 
...
kbl(genotype.table, 
    caption = 'A frequency table for the actn3.r577x variable.') %>% 
  kable_styling()
```



```{r famussRelFrequencyTable, echo=FALSE}
data(famuss); 
...
kbl(genotype.table, 
    caption = 'A relative frequency table for the actn3.r577x variable.',
    digits = 3) %>% 
  kable_styling()
```
