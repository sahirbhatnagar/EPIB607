# Foundational Skills {#packages}

::: {.rmdnote}
This section is slightly modified from the book Data Science in Education Using R [@dataedu].
:::
...
knitr::include_graphics("./inst/figures/Figure 6.1.png")
```
