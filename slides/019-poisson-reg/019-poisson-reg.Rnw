...
pt <- read.table("~/git_repositories/EPIB607/slides/019-poisson-reg/denmark_person_time.txt", skip = 1, 
header = TRUE)
pt$type <- "PT"
deaths <- read.table("~/git_repositories/EPIB607/slides/019-poisson-reg/denmark_deaths.txt", skip = 1, 
header = TRUE)
deaths$type <- "deaths"
df <- rbind(pt, deaths)
