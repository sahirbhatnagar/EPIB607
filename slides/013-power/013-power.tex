...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# If X \textasciitilde{} N(-0.54, 0.0036), then}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in file(filename, "{}r"{}, encoding = encoding): cannot open the connection to 'https://raw.githubusercontent.com/sahirbhatnagar/EPIB607/master/code/plot\_null\_alt.R'}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in power\_plot(n = 9, s = 15, mu0 = 100, mha = 110, cutoff = 100 + : could not find function "{}power\_plot"{}}}\end{kframe}
\end{knitrout}
\end{frame}
